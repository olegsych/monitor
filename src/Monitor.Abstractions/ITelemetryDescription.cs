...
namespace Monitor
{
    ...
    public interface ITelemetryDescription<TSubject>
    {
        ...
        /// </summary>
        void AddProperty<TValue>(Expression<Func<TSubject, TValue>> getter, string? name = null);

        /// <summary>
        /// Adds a metric to telemetry of <typeparamref name="TSubject"/>.
        /// Metrics must be convertible to integer for aggregation.
        /// </summary>
        void AddMetric<TValue>(Expression<Func<TSubject, TValue>> getter, string? name = null);
        ...
        /// </summary>
        void AddDimension<TValue>(Expression<Func<TSubject, TValue>> getter, string? name = null);
    }
}
